...
#All offspring (100%) of a will be dominant
a_prob= a * 1 * 2

#All offspring (100%) of b will be dominant
b_prob = b * 1 * 2

#All offspring (100%) of c will be dominant
c_prob = c * 1 * 2

#75% of offspring of d will be dominant
d_prob = d * .75 * 2

#50% of offspring of e will be dominant
e_prob = e * 0.5 * 2

#0% of offspring of f will be dominant
f_prob = f * 0 * 2


total = a_prob + b_prob + c_prob + d_prob + e_prob + f_prob
print(total)
